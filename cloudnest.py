        ...
        if (do_clouds[i] != 0):
            for j in range (0, nclouds):
                if ((cloudtype[i,j] == 2) and (cloudnum[i,j] == 99)):
                    cloudparams[1:3,i,j] = theta[pc+nc:pc+2+nc]
                    nc = nc + 2
                    ...
                    cloudparams[1,i,j] = theta[pc+nc]
                    cloudparams[4,i,j] = theta[pc+nc+1]
                    nc = nc + 2
                elif ((cloudtype[i,j] == 4) and (cloudnum[i,j] < 80)):
                    cloudparams[1,i,j] = theta[pc+nc]
    ...
    if (do_clouds[0] != 0):
        for j in range (0, nclouds):
            if ((cloudtype[0,j] == 2) and (cloudnum[0,j] == 99)):
                cloudparams[1:3,0,j] = theta[pc+nc:pc+2+nc]
                nc = nc + 2
            elif ((cloudtype[0,j] == 1) and (cloudnum[0,j] == 99)):
                cloudparams[0:3,0,j] = theta[pc+nc:pc+3+nc]
                nc = nc + 3
            elif ((cloudtype[0,j] == 1) and (cloudnum[0,j] == 89)):
                cloudparams[0:3,0,j] = theta[pc+nc:pc+3+nc]
                cloudparams[4,0,j] = theta[pc+4+nc]
                nc = nc + 4
            elif ((cloudtype[0,j] == 2) and (cloudnum[0,j] == 89)):
                cloudparams[1:3,0,j] = theta[pc+nc:pc+3+nc]
                cloudparams[4,0,j] = theta[pc+nc+3]
                nc = nc + 3
            elif ((cloudtype[0,j] == 2) and (cloudnum[0,j] < 80)):
                ...
                cloudparams[4,0,j] = theta[pc+nc+3]
                nc = nc + 3
            elif ((cloudtype[0,j] == 3) and (cloudnum[0,j] < 80)):
                cloudparams[0:2,0,j] = theta[pc+nc:pc+nc+2]
                ...
                cloudparams[1,0,j] = theta[pc+nc]
                cloudparams[4,0,j] = theta[pc+nc+1]
                nc = nc + 2
            elif ((cloudtype[0,j] == 4) and (cloudnum[0,j] < 80)):
                cloudparams[1,0,j] = theta[pc+nc]
